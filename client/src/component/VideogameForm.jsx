    ...
    <>
      <div className=" flex justify-center">
        <form onSubmit={handleSubmit}>
          <h1 className=" text-2xl font-semibold py-4 bg-gradient-to-r from-purple-400 to-pink-600 px-5 rounded-xl mb-6 mt-7 ">
            Add Videogame Fields:
          </h1>
          <div className="flex-col ml-11">
            ...
            <div>
              <h3 className=" py-2 font-semibold text-xl">Add cover image</h3>
              <input
          ...
          <div>
            <button className="py-3 ml-20 my-6 rounded-full font-semibold px-4 bg text-xl text-white bg-purple-500">
              Submit!
            </button>
